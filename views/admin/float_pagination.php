...
<ul class="pagination center">
    ...
    <!--        <li><a href="--><?php //echo HTML::chars($page->url($previous_page)) ?><!--">&leftarrow; --><?php //echo __('Previous') ?><!--</a></li>-->
    <!--    --><?php //endif ?>
    ...
    <!--        <li><a href="--><?php //echo HTML::chars($page->url($next_page)) ?><!--">--><?php //echo __('Next') ?><!-- &rightarrow;</a></li>-->
    <!--    --><?php //endif ?>
