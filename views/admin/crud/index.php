...
<thead>
    ...
    <?foreach($list_fields as $field):?>
        ...
        <a href="<?php echo URL::base().$crud_uri?><?php echo URL::query()?>&orderby=<?php echo $field?>&orderdir=DESC"><span class="glyphicon glyphicon-arrow-up"></span></a><?php echo $labels[$field]?><a href="<?php echo URL::base().$crud_uri?><?php echo URL::query()?>&orderby=<?php echo $field?>&orderdir=ASC"><span class="glyphicon glyphicon-arrow-down"></span></a>
